...
if (mysqli_connect_errno()){
	...
	try{
		...
		$tables = array(
			...
			"CREATE TABLE ".$getPrefix."posts (`id` int(11) NOT NULL AUTO_INCREMENT, `title` varchar(200) DEFAULT NULL, `author` int(11) NOT NULL,`category` int(11) DEFAULT NULL,`date_created` timestamp NULL DEFAULT CURRENT_TIMESTAMP,`body` longtext,`reviewer` varchar(100) DEFAULT '0',`featured` tinyint(1) NOT NULL,`post_type` varchar(100) NOT NULL DEFAULT 'post')",
			"CREATE TABLE ".$getPrefix."post_tags (`id` int(11) NOT NULL,`post_id` int(11) NOT NULL,`tag_id` int(11) NOT NULL)",
			"CREATE TABLE ".$getPrefix."tags (`id` int(11) NOT NULL,`tag_name` varchar(60) NOT NULL)"
		);
