...
if (mysqli_connect_errno()){
	...
	try{
		...
		$tables = array(
			...
			"CREATE TABLE ".$getPrefix."users (`id` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,`first_name` varchar(60) NOT NULL,`last_name` varchar(60) NOT NULL,`email` varchar(100) NOT NULL,`password` varchar(255) NOT NULL, `role` int not null default 1)",
